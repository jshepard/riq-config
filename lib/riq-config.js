...
var getConfigFor = function(environmentName, roleName, configPath){
  ...
  environmentName = isValidConfig((environmentName || process.env.NODE_ENV || 'development'), configEnvPath);
  roleName = isValidConfig((roleName || process.env.ROLE_NAME), configRolePath);
